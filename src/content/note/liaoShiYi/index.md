...
需计算$B_n = \underbrace{666\cdots666}_{n} \times \underbrace{666\cdots666}_{n}$ 的前n项和, 且$1 \leq n \leq 10^7$, 如果我们用常规两数相乘，两个n位的数相乘最大会产生一个$2*n$位的数, 而long long的范围也仅仅到$19$位数字，所以会爆long long, 所以我们要进行优化。  

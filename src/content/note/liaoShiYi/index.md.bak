...
需计算$$B_n = \underbrace{666\cdots666}_{n个6} \times \underbrace{666\cdots666}_{n个6}$$ 的前n项和, 且$$1 \leq n \leq 10^7$$, 如果我们用常规两数相乘，两个n位的数相乘最大会产生一个$$2*n$$位的数, 而long long的范围也仅仅到19位数字，所以会爆long long, 所以我们要进行优化。  
...
但是我们还要注意，我们只是需要知道$$B_n$$的前$$n$$项和，而这个公式他可能包含后面多项的相同位置上的数！比如我们只要到第3项的第5位，而它包含第4项的第5位！
并且我们可以发现规律，从第n+2位开始到第2*n-1位，我们多加了$$(1)[2](3)...项, ()为奇数项$$, 我们只需在$$i>=n+2$$的时候减去这些多余的项即可
